...
namespace CrossEngine.Rendering.Lines
{
    public class LineRenderer
    {
        ...
        {
            data.lineVertexArray = new VertexArray();

            data.lineVertexBuffer = new VertexBuffer(null, (int)(LineRendererData.MaxVertices * sizeof(LineVertex)), BufferUsage.DynamicDraw);
            ...
            data.lineShader = new Shader(VertexShaderSource, FragmentShaderSource);
        }
        ...
        static unsafe void Flush()
        {
            ...
            fixed (LineVertex* p = &data.lineVertexBufferBase[0])
            {
                ...
                data.lineVertexBuffer.SetData(p, (int)dataSize);
            }

            data.lineShader.Use();
            Renderer.DrawArrays(DrawMode.Lines, data.lineVertexArray, (int)data.lineCount * 2);
